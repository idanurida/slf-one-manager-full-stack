// src/components/project-lead/ChecklistApproval.js
      ...
      try {
        ...
        let query = supabase
          ...
          .select(`
            ...
            responded_at,
            status,
            inspections!fk_checklist_responses_inspections(
              id,
              project_id,
              inspector_id,
              date,
              ...
              profiles!inspections_inspector_id_fkey(full_name, email, specialization)
            ),

...
// Main Component
export default function ProjectLeadCommunicationPage() {
  ...
  const handleOpenChat = (projectId, clientId) => {
    ...
    // Contoh URL: /dashboard/project-lead/communication/chat?project=...&client=...
    router.push(`/dashboard/project-lead/communication/chat?project=${projectId}&client=${clientId}`);
  };
        ...
        >
          ...
          <motion.div variants={itemVariants} className="flex justify-between items-start">
            <div>
              ...
              <p className="text-slate-600 dark:text-slate-400">
                Lihat dan tanggapi pesan dari client terkait proyek yang Anda tangani.
              </p>
            </div>

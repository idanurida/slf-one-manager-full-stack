...
const getRoleLabel = (role) => {
  const labels = {
    ...
    project_lead: 'Project Lead', // Meskipun ini adalah halaman PL, mereka bisa melihat PL lain di proyek lain
    inspector: 'Inspector',
...
export default function ProjectLeadTeamPage() {
  ...
  const handleSendMessage = (userId) => {
    ...
    // router.push(`/dashboard/project-lead/communication/chat?with=${userId}`);
          ...
          <motion.div variants={itemVariants} className="flex justify-between items-start">
            <div>
              ...
              <p className="text-slate-600 dark:text-slate-400">
                Koordinasikan dengan tim yang ditugaskan ke proyek Anda.
              </p>
            </div>
            <div className="flex items-center space-x-3">
              <Button

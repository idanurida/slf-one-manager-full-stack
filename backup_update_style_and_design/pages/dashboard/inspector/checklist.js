    ...
    <DashboardLayout>
      <div className="min-h-[80vh] flex flex-col items-center justify-center p-6 text-center">
        <motion.div
          ...
          className="max-w-md w-full bg-card p-12 rounded-[3.5rem] shadow-2xl shadow-slate-200/50 dark:shadow-none border border-border space-y-8"
        >
          ...
          <div className="space-y-4">
            <h1 className="text-3xl font-black tracking-tighter text-slate-800 dark:text-white leading-none">
          ...
          <div className="bg-slate-50 dark:bg-white/5 p-6 rounded-3xl flex items-center gap-4 text-left border border-border">
            ...
            <div>
              ...
              <p className="text-sm font-black text-slate-700 dark:text-slate-200">Menuju inspeksi saya...</p>
            </div>
          </div>

// FILE: src/components/approvals/HeadConsultantApproval.js
"use client";
...
// --- Main Component ---
const HeadConsultantApproval = ({ report, projectId, inspectionId, onApprovalChange }) => {
  ...
  const handleApprove = async () => {
    ...
    try {
        ...
        .insert([
          {
            ...
            role: 'head_consultant', // ✅ Role tetap head_consultant
            status: 'approved',
            comment: comment,
      ...
      console.error('[HeadConsultantApproval] Approve error:', error);
  ...
  const handleReject = async () => {
    ...
    try {
      ...
      console.error('[HeadConsultantApproval] Reject error:', error);
        ...
        <CardContent className="p-6">
          <div className="space-y-6"> {/* ✅ Ganti VStack dengan div space-y-6 */}
            <div> {/* ✅ Ganti Box dengan div */}
              <h2 className="text-xl md:text-2xl font-semibold text-purple.600 mb-2"> {/* ✅ Ganti Heading dengan h2 */}
                Persetujuan Head Consultant
              </h2>
            ...
            <Alert variant="warning" className="m-4"> {/* ✅ Ganti Alert Chakra dengan Alert shadcn/ui dan tambahkan m-4 */}
              <AlertTriangle className="h-4 w-4" /> {/* ✅ Tambahkan ikon AlertTriangle */}
              ...
              <AlertDescription> {/* ✅ Ganti AlertDescription Chakra dengan AlertDescription shadcn/ui */}
                ...
                telah sesuai dengan regulasi Permen PUPR No 27/2018 dan No 3/2020.
              </AlertDescription>
            </Alert>
            ...
            <div className="flex justify-end gap-4"> {/* ✅ Ganti HStack dengan div flex justify-end gap-4 */}
              ...
              <Button
                variant="default" // ✅ Ganti colorScheme="purple" dengan variant="default"
                onClick={handleApprove}
                disabled={loading || !report.id} // ✅ Ganti isLoading dan isDisabled
                className="flex items-center gap-2 bg-purple-600 text-white hover:bg-purple-700 dark:hover:bg-purple-800" // ✅ Tambahkan class Tailwind untuk warna ungu
              >
                {loading ? (
                  <>
                    <Loader2 className="w-4 h-4 animate-spin" />
...
export default HeadConsultantApproval;

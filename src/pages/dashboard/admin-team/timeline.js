          ...
          <motion.div variants={itemVariants}>
            {loading ? (
              ...
              <div className="py-32 bg-white dark:bg-[#1e293b] rounded-[2.5rem] border border-slate-100 dark:border-white/5 flex flex-col items-center justify-center text-center p-10">
                ...
                <h3 className="text-2xl font-black uppercase tracking-tighter">Tidak Ada Proyek</h3>
  ...
  return (
    ...
    >
      ...
      <div className="flex-1">
        ...
        <div className="mt-8 space-y-6">
          <div className="flex items-center justify-between">
            ...
            <span className="text-[10px] font-black text-slate-900 dark:text-white uppercase tracking-widest">{Math.round(progress)}%</span>
          </div>
          ...
          <div className="flex justify-between items-center relative pt-4 px-2">
            ...
            {phaseNames.map((name, idx) => (
              <div key={name} className="flex flex-col items-center gap-2 relative z-10">
                ...
                <span className={`text-[8px] font-black uppercase tracking-tighter ${idx + 1 <= currentPhase ? 'text-[#7c3aed]' : 'text-slate-400'
                  }`}>{name}</span>
              </div>
            ))}
          </div>
      ...
      <div className="mt-10 flex gap-3 pt-6 border-t border-slate-50 dark:border-white/5">
        <button onClick={() => onView(project)} className="h-12 flex-1 bg-white dark:bg-white/5 border border-slate-100 dark:border-white/5 text-slate-900 dark:text-white rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-slate-50 dark:hover:bg-white/10 transition-all flex items-center justify-center gap-2">
          <Eye size={14} /> View
        </button>

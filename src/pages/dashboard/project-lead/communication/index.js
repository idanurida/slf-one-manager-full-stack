...
export default function CommunicationInbox() {
    ...
    const fetchData = useCallback(async () => {
        ...
        `)
            ...
            // 4. Client Conversations (Unified in convos if they are in projects)
                                            ...
                                            <div className="flex items-center gap-5 relative z-10">
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    ...
                                                    <div className="flex items-center gap-2 mb-2">
                                                        <Badge variant="outline" className="text-[10px] py-0 h-5 px-2 bg-slate-50 dark:bg-slate-900 border-none text-slate-500 tracking-wider">{contact.role.replace(/_/g, ' ')}</Badge>

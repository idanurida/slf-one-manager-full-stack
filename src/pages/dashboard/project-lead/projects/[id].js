// FILE: src/pages/dashboard/project-lead/projects/[id].js
...
export default function ProjectLeadProjectDetailPage() {
  ...
  const hasAccess = isAuthenticated && isProjectLead;
  ...
  const fetchProjectData = async () => {
    ...
    try {
      ...
      if (projectData.project_lead?.role !== 'project_lead') {
        ...
        setError('Konfigurasi proyek tidak valid: Project Lead harus memiliki role project_lead');
        return;
      }
    ...
    try {
      ...
      const { error: notifErr } = await supabase
        ...
        .insert([{
          ...
          message: `Laporan final untuk proyek ${project.name} telah diserahkan oleh Project Lead. Catatan: ${reportNotes || 'Tidak ada catatan'}`,
          sender_id: user.id,
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <Card>
                  ...
                  <CardContent className="space-y-3">
                    ...
                    <div className="flex justify-between items-center">
                      <span className="text-sm text-slate-600">Project Lead:</span>

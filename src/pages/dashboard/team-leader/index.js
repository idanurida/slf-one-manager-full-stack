...
export default function TeamLeaderDashboard() {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      handleApiError(error, 'TeamLeaderDashboard', {
        fallbackMessage: 'Gagal memuat data dashboard'
      });
    } finally {
      setLoading(false);
    }
      ...
      <DashboardLayout title="Dashboard">
        <div className="p-6">
          <Alert variant="destructive">
            ...
            <AlertDescription>
              Hanya Team Leader yang dapat mengakses halaman ini.
            </AlertDescription>
          </Alert>
        </div>
      </DashboardLayout>
  ...
  return (
    <DashboardLayout title="Dashboard">
      <div className="p-4 md:p-6 space-y-6 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            <h1 className="text-2xl font-bold">
              Selamat Datang, {profile?.full_name?.split(' ')[0] || 'Team Leader'}
            </h1>
        ...
        {/* Stats Cards */}
        <div className="grid gap-4 md:grid-cols-4">
          <Card className="cursor-pointer hover:shadow-md transition-shadow" onClick={() => router.push('/dashboard/team-leader/projects')}>
          ...
          <Card className="cursor-pointer hover:shadow-md transition-shadow" onClick={() => router.push('/dashboard/team-leader/reports')}>
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div>
          ...
          <Card className="cursor-pointer hover:shadow-md transition-shadow" onClick={() => router.push('/dashboard/team-leader/team')}>
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div>

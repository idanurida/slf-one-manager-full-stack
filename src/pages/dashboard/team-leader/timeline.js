// FILE: src/pages/dashboard/team-leader/timeline.js
...
const getStatusLabel = (status) => {
  const labels = {
    ...
    'approved_by_pl': 'Approved by Team Leader',
    'rejected_by_pl': 'Rejected by Team Leader',
...
export default function TeamLeaderTimelinePage() {
  ...
  }, [router.isReady, authLoading, user, hasAccess, fetchData, router]);
  ...
  const handleViewTimeline = (projectId) => {
    router.push(`/dashboard/team-leader/projects/${projectId}/timeline`); // Misalnya ke halaman detail timeline
  };
